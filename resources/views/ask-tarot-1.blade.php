...
<link rel='stylesheet' id='astra-theme-css-css' href="{{ asset('frontend/tarot/asset/wp-content/themes/tarotmoon/wp-content/themes/astra/assets/css/unminified/style74067406.css?ver=2.0.1') }}" type='text/css' media='all'  />

<link rel='stylesheet' id='astra-child-theme-css-css' href="{{ asset('frontend/tarot/asset/wp-content/themes/tarotmoon/wp-content/themes/astra-child/style8a548a54.css?ver=1.0.0') }}" type='text/css' media='all' />
<script type='text/javascript' src="{{ asset('frontend/tarot/asset/wp-content/themes/tarotmoon/wp-includes/js/jquery/jquery4a5f4a5f.js?ver=1.12.4-wp') }}"></script>
<link rel="stylesheet" href="{{ asset('frontend/tarot/asset/wp-content/themes/tarotmoon/wp-content/themes/astra/custom-css.css') }}" />
<link rel='stylesheet' id='magicards-style-css' href="{{ asset('frontend/tarot/asset/wp-content/plugins/magicards/css/magicardsc801.css?ver=1.9.3') }}" type='text/css' media='all' />

<link rel="stylesheet" href="{{ asset('frontend/tarot/asset/wp-content/themes/tarotmoon/wp-content/themes/astra/custom.css') }}" />
...
<link rel="stylesheet" href="{{ asset('frontend/tarot/asset/wp-content/themes/tarotmoon/css/responsive-magicards.css') }}" />
<link rel="stylesheet" href="{{ asset('frontend/tarot/asset/font-awesome/4.7.0/css/font-awesome.min.css') }}" />
<link rel="stylesheet" href="{{ asset('frontend/tarot/asset/wp-content/themes/tarotmoon/jquery-editable-select.min.css') }}" />
																	...
																	<div class="fl-widget">
																		<div class="widget widget_magicards_widget">
																			<div class="magicards-deck-wrap ">
																					...
																					<div class="magicard-wrap">
																						<div class="magicard-flipper ">
																							<div class="magicard-front"><img
																									src="{{ asset('frontend/tarot/asset/wp-content/uploads/2021/12/Back-Of-Card.png') }}"
																									class="skip-lazy"></div>
																							<div class="magicard-back"><img
																									src="{{ asset('frontend/tarot/asset/wp-content/uploads/2021/12/The-Nine-Of-Cups.png')}}"
																									class="skip-lazy"></div>
																				...
																				<div class="magicard-commands align-center">
																					<table id="bts">
																						<tr>
																							<td>
																								<div
																									class="magicard-shuffle">
																									<i
