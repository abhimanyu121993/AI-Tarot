            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 p-2"><input type="text" name="name" placeholder="Enter your Name" class="form-control"></div>
                    ...
                    <button type="button" style="background: #00ffa3;float:right;margin-right:0.5rem" class="btn">Submit</button>
                    </form>
